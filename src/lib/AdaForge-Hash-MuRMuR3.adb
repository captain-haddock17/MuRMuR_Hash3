...
package body AdaForge.Hash.MuRMuR3  is
   ...
   -- ----------------------------------------- --
   -- Hash_32() return Ada.Containers.Hash_Type --
   -- ----------------------------------------- --
   function Hash_32 (
               Key: Object;
               Length : Natural := Object'Size / 8;
      ...
      is (Ada.Containers.Hash_Type (Hash_32_Unsigned_32 (Key, Length, Seed)));
